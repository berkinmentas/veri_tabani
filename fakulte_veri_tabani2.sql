create database if not exists fakulte;
use fakulte;
create table bolum (
...
select distinct vize from ogrenci_Ders;
select * from ogrenci where isim='Berkin';
select * from ogrenci where isim='Murat';
select * from ogrenci_ders where ders_id=3 AND vize=60;
select * from ogrenci ORDER BY isim;
select * from ogrenci ORDER BY abd_id DESC;
select * from ders where ders_adi LIKE 'K%';
select * from ders where ders_adi LIKE '%a';
select * from ogrenci_ders where vize between 60 and 80;
select * from ogrenci_ders where final between 40 and 60;
select * from anabilim Limit 3;
select * from anabilim limit 2,2;
select * from anabilim order by id desc limit 2;
select * from bolum limit 3,5;
select * from bolum limit 1,3;
select * from anabilim;
select * from ders;